import 'package:cgpa_application/presentation/cgpa_screen/subject.dart';
...
myTextFormT1({required hintText, required controller, required validator}) {
  return TextFormField(
    ...
    decoration: InputDecoration(
      focusColor: MyColor.myRed,
      floatingLabelStyle: const TextStyle(color: MyColor.myRed),
  ...
  return Padding(
    ...
    child: Row(
      ...
      children: [
        Expanded(
            child: myTextFormT2(
                controller: mySubject.subjectName,
                validator: (value) {
                  if (value!.isEmpty) {
                    return "You are required to fill";
                  }
                  return null;
                })),
        const SizedBox(
